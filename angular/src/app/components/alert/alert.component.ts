...
export class AlertComponent implements OnInit, OnDestroy {
    ...
    onAlertRemoved(id: string | undefined) {
      if(this.queue && this.queue.length && this.maxItems > this.alerts.length){
        let alert : any | undefined = this.queue.pop();
    ...
    public showAlert(alert: Alert): string | undefined{
      if(!alert){
        return "";
      }
    ...
    public show(message: string, title: string, type: AlertType, delay: number = 0, id: string = ''): string | undefined {
      let alert = new Alert();
      alert.id = id;
    ...
    public error(message: string, title: string, delay: number = 0, id: string = ''): string | undefined{
      return this.show(message, title, AlertType.error, delay, id);
    }

    public success(message: string, title: string, delay: number = 0, id: string = ''): string | undefined{
      return this.show(message, title, AlertType.success, delay, id);
    }

    public info(message: string, title: string, delay: number = 0, id: string = ''): string | undefined{
      return this.show(message, title, AlertType.info, delay, id);
    }

    public warning(message: string, title: string, delay: number = 0, id: string = ''): string | undefined{
